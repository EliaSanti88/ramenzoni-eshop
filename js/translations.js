...
const translations = {
    it: {
        'hero.title': 'L\'Arte del Caffè e dell\'Olio Italiano',
        'hero.subtitle': 'Dalle colline di Parma alle vie di Praga, portiamo la tradizione italiana del caffè e dell\'olio extravergine direttamente a casa tua.',
        ...
        'checkout.phone': 'Telefono (opzionale)',
        ...
        'footer.description': 'Dal 1950, la passione per il caffè e l\'olio d\'oliva di qualità che unisce Italia e Repubblica Ceca.',
    ...
    cz: {
        'hero.title': 'Umění Italské Kávy a Oleje',
        'hero.subtitle': 'Z kopců Parmy do ulic Prahy, přinášíme italskou tradici kávy a extra panenského olivového oleje přímo k vám domů.',
        'hero.cta': 'Objevte Naše Produkty',
        ...
        'checkout.email': 'Email',
        'checkout.phone': 'Telefon (volitelné)',
        ...
        'footer.description': 'Od roku 1950, vášeň pro kvalitní kávu a olivový olej spojující Itálii a Českou republiku.',
    ...
    en: {
        'hero.title': 'The Art of Italian Coffee and Oil',
        'hero.subtitle': 'From the hills of Parma to the streets of Prague, we bring Italian coffee and extra virgin olive oil tradition directly to your home.',
        ...
        'footer.description': 'Since 1950, the passion for quality coffee and olive oil connecting Italy and Czech Republic.',
